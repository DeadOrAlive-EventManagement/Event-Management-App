...
INSERT INTO `Events` (`event_id`, `event_name`, `customer_id`, `budget`, `num_people`, `date_event`, `service_id`, `vendor_id`) VALUES
(300, 'birthday', 1, 10000, 50, '2018-10-31', 90, 20);
...
ALTER TABLE `Events`
  ...
  ADD CONSTRAINT `Events_ibfk_3` FOREIGN KEY (`vendor_id`) REFERENCES `Vendor` (`vendor_id`);

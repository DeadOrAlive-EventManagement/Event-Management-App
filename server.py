...
def do_register():
    ...
    if(vendor):
        ...
        print("enter this into vendor DB")
        ...
        if(results):
            ...
            sql = """INSERT INTO Vendor(email,vendor_name,vendor_location,phone_number,pwd) values(%s,%s,%s,%s,%s)"""
            args = (email,names[0],location,number,hashed_pwd)
